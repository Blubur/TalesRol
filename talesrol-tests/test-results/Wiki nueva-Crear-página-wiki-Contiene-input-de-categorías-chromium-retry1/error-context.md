...
- Name: Wiki nueva.spec.ts >> Crear página wiki >> Contiene input de categorías
- Location: tests\Wiki nueva.spec.ts:46:7
...
Locator:  locator('input.wpf-input')
Expected: 2
Received: 0
Timeout:  8000ms
...
Call log:
  ...
  - waiting for locator('input.wpf-input')
