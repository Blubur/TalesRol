...
- Name: Wiki nueva.spec.ts >> Crear página wiki >> Contiene input de título
- Location: tests\Wiki nueva.spec.ts:32:7
...
Locator: locator('input.wpf-input').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('input.wpf-input').first()
