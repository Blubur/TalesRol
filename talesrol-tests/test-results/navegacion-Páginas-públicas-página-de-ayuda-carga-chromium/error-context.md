...
- Name: navegacion.spec.ts >> Páginas públicas >> página de ayuda carga
- Location: tests\navegacion.spec.ts:32:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/ayuda
Call log:
  - navigating to "http://localhost:3000/ayuda", waiting until "load"
