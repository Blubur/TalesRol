...
- Name: Wiki nueva.spec.ts >> Crear página wiki >> El checkbox de portada existe
- Location: tests\Wiki nueva.spec.ts:70:7
...
Locator: locator('input.wpf-checkbox')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('input.wpf-checkbox')
