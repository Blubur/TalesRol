...
- Name: bugs conocidos.spec.ts >> Regresión — bugs documentados >> [BUG] Próximos eventos en PA no debe lanzar error de cliente
- Location: tests\bugs conocidos.spec.ts:46:7
