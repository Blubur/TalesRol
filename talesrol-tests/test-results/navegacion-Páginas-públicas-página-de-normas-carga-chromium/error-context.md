...
- Name: navegacion.spec.ts >> Páginas públicas >> página de normas carga
- Location: tests\navegacion.spec.ts:26:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/normas
Call log:
  - navigating to "http://localhost:3000/normas", waiting until "load"
