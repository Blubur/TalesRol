...
- Name: Wiki nueva.spec.ts >> Crear página wiki >> El botón de guardar existe y está habilitado
- Location: tests\Wiki nueva.spec.ts:54:7
...
Locator: locator('button.btn-primary')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('button.btn-primary')
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e36]:
      ...
      - main [ref=e113]:
        - generic [ref=e115]:
          - heading "404" [level=1] [ref=e116]
          - heading "This page could not be found." [level=2] [ref=e118]
      ...
      - generic [ref=e120]:
        - generic [ref=e121]:
          - generic [ref=e122]:
            - generic [ref=e123]: ✦
            - text: TalesRol
          - generic [ref=e124]: © 2026 — Plataforma de Roleplay en español
        - generic [ref=e125]:
          - link "Normas" [ref=e126] [cursor=pointer]:
            - /url: /normas
