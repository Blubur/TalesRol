...
- Name: Usuarios.spec.ts >> Listado de usuarios >> Las tarjetas de usuario enlazan a perfil
- Location: tests\Usuarios.spec.ts:45:7
...
Locator: locator('a.user-card').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('a.user-card').first()
