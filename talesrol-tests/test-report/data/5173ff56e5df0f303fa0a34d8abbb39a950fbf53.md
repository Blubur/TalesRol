...
- Name: Usuarios.spec.ts >> Listado de usuarios >> El buscador está visible y funciona
- Location: tests\Usuarios.spec.ts:21:7
...
Locator: locator('input.users-search')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input.users-search')
