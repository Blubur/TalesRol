...
- Name: navegacion.spec.ts >> Páginas públicas >> listado de salas visible sin login
- Location: tests\navegacion.spec.ts:44:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/salas
Call log:
  - navigating to "http://localhost:3000/salas", waiting until "load"
