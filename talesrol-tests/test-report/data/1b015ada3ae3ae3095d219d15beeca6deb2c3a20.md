...
- Name: personajes perfil.spec.ts >> Personajes >> crear personaje nuevo
- Location: tests\personajes perfil.spec.ts:34:7

# Error details

```
Error: page.goto: net::ERR_NETWORK_CHANGED at http://localhost:3000/auth/login
Call log:
...
- generic [ref=e3]:
  - generic [ref=e6]:
    - heading "Se ha interrumpido la conexión" [level=1] [ref=e7]
    - paragraph [ref=e8]: Se ha detectado un cambio de red.
    - generic [ref=e9]: ERR_NETWORK_CHANGED
  - button "Volver a cargar" [ref=e12] [cursor=pointer]
```
