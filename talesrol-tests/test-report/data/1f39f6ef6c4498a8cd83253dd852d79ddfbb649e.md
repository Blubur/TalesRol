...
- Name: bugs conocidos.spec.ts >> Regresión — bugs documentados >> [BUG] dice_enabled = false debe bloquear tiradas de dado
- Location: tests\bugs conocidos.spec.ts:114:7
