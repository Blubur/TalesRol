...
- Name: navegacion.spec.ts >> Páginas públicas >> página de anuncios carga
- Location: tests\navegacion.spec.ts:38:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/anuncios
Call log:
  - navigating to "http://localhost:3000/anuncios", waiting until "load"
