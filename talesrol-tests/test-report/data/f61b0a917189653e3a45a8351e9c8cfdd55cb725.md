...
- Name: Usuarios.spec.ts >> Listado de usuarios >> La página carga y muestra el título Comunidad
- Location: tests\Usuarios.spec.ts:15:7
...
Locator: locator('h1.users-title')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('h1.users-title')
